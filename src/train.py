...
import pathlib
import sys
from urllib.parse import urlparse #pour l'url de la base de données 
...
import pandas as pd 
import yaml
from sklearn.ensemble import RandomForestClassifier #pour le modèle random forest
from sklearn.metrics import (
    ...
    precision_score,
    recall_score,
) #les metriques pour la performance du modèle
from sklearn.neighbors import KNeighborsClassifier #modèle plus proche voisin
